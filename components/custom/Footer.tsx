...
export default function Footer() {
    ...
    return (
        <footer className="w-full relative select-none font-sans overflow-x-hidden">
            <div className="relative w-full pt-20">
                <div className="absolute bottom-0 left-0 w-full h-[450px] md:h-[540px] bg-[#133C1E] rounded-t-[40px] z-10" />

                <div className="max-w-[1440px] mx-auto relative px-4 sm:px-6 md:px-12 pb-14 z-20">
            ...
            <div className="w-full bg-[#BF9C66] text-[#3C3120] relative z-10">
                <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-14 pb-6">
